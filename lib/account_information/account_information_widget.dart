...
class AccountInformationWidget extends StatefulWidget {
  /// Account Information from username,name, age, gender
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRow> accountInformationUserRowList = snapshot.data!;

        final accountInformationUserRow =
            accountInformationUserRowList.isNotEmpty
                ? accountInformationUserRowList.first
                : null;
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      accountInformationUserRow?.gender,
                                      'Empty',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      accountInformationUserRow?.skinColor,
                                      'Empty',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      accountInformationUserRow?.marriedStatus,
                                      'Empty',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      accountInformationUserRow?.country,
                                      'Empty',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      accountInformationUserRow?.city,
                                      'Empty',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
