    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case MessageRoomRow:
            return MessageRoomRow(data);
          case SubscriptionRow:
            return SubscriptionRow(data);
          case ArchiveRow:
            return ArchiveRow(data);
          case VideoCallRow:
            return VideoCallRow(data);
          case OldImagesRow:
            return OldImagesRow(data);
          case ProfileViewRow:
            return ProfileViewRow(data);
          default:
            return null;
        }
